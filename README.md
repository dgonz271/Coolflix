# Coolflix
Coolflix is an app that allows users to browse movies from the [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
<img src="coolflix_part2.gif" width=250><br>
